  ...
  $(modalSelector).on('shown.bs.modal', function() {
    ...
    const cropperOptions = {
      ...
      ready: function() {
        ...
        // Calcular el tamaÃ±o de la caja de recorte circular
        var minSize = Math.min(cropBoxWidth, cropBoxHeight);
        var circularCropBoxSize = Math.floor(minSize * 0.8); // Puedes ajustar el tamaÃ±o aquÃ­

        // Calcular la posiciÃ³n de la caja de recorte circular
